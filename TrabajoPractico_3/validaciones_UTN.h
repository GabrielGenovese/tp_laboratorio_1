...
/*brief valida que lo ingresado sea menor a cantidadArray caracteres, si es mayor pide que vuelvas a ingresar.
 * param1 variable pasada por referencia donde se guardara el string despues de validarlo.
 * param2 mensaje con el cual se pide la entrada de datos especifica.
 * param3 cantidad de elementos que tiene el string.
 * return retorna 0 si no hubo errores y -1 si no pudo validad.
 * */
 ...
 * return retorna 0 si no hubo errores y -1 si no pudo validad.
 * */
int validacionStringNumerico(char string[], char mensaje[],int cantidadArray);
